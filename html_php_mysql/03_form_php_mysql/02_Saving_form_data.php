    ...
    <div class="container">
      <div class="row justify-content-md-center">
        ...
        if (isset($_POST['submit'])) {
          ...
          $query = "INSERT INTO student_info (sid, fname, mname, lname, street_no, str_name, city, department, dob, semester, year) VALUES ('".$student_id."', '".$first_name."', '".$middle_name."', '".$last_name."', '".$street_number."', '".$street_name."', '".$city_name."', '".$department_name."', '".$date_of_birth."', '".$semester."', ".$year.")";
        ...
        <div class="col-md-8">
          <form class="" action="02_Saving_form_data.php" method="post">
